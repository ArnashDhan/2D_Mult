...
namespace Sample.Deployment.EconomySample
{
    public class Economy : MonoBehaviour
    {
        ...
        public async void IncreaseBalance(int wining)
        {
            try
            {
                PlayerBalance newBalance = await EconomyService.Instance.PlayerBalances.IncrementBalanceAsync(CurrencyId, wining);
